...
/// Resultado del análisis del struct derivado: campo `id` separado del resto.
...
/// Analiza el [`DeriveInput`] y separa el campo `id` de los demás campos.
/// Retorna error si el struct no tiene campo `id` o no usa campos nombrados.
